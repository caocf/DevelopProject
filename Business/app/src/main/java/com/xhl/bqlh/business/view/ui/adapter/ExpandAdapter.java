...
public class ExpandAdapter implements ExpandableListAdapter {
    ...
    public ExpandAdapter(Context context, List<BusinessTypeModel> types) {
        this.mTypes = types;
    ...
    public int getChildrenCount(int groupPosition) {
        BusinessTypeModel model = mTypes.get(groupPosition);
        List<BusinessTypeModel> children = model.getChildren();
        return children == null ? 0 : children.size();
    }

    @Override
    public BusinessTypeModel getGroup(int groupPosition) {
        return mTypes.get(groupPosition);
    }

    @Override
    public BusinessTypeModel getChild(int groupPosition, int childPosition) {
