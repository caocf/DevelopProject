package com.xhl.sum.chatlibrary.adapter;
...
import com.xhl.sum.chatlibrary.viewholder.ChatItemHolder;
import com.xhl.sum.chatlibrary.viewholder.ChatItemImageHolder;
import com.xhl.sum.chatlibrary.viewholder.ChatItemLocationHolder;
import com.xhl.sum.chatlibrary.viewholder.ChatItemTextHolder;
import com.xhl.sum.chatlibrary.viewholder.CommonViewHolder;
...
public class MultipleItemAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void setChatAvatar(String userLogo, String shopLogo) {
        mUserLogo = userLogo;
        mShopLogo = shopLogo;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case ITEM_LEFT_TEXT:
                holder = new ChatItemTextHolder(parent.getContext(), parent, true);
                break;
            case ITEM_LEFT_IMAGE:
                holder = new ChatItemImageHolder(parent.getContext(), parent, true);
                break;
            case ITEM_LEFT_LOCATION:
                holder = new ChatItemLocationHolder(parent.getContext(), parent, true);
                break;
            case ITEM_RIGHT_TEXT:
                holder = new ChatItemTextHolder(parent.getContext(), parent, false);
                break;
            case ITEM_RIGHT_IMAGE:
                holder = new ChatItemImageHolder(parent.getContext(), parent, false);
                break;
            case ITEM_RIGHT_LOCATION:
                holder = new ChatItemLocationHolder(parent.getContext(), parent, false);
                break;
            default:
                holder = new ChatItemTextHolder(parent.getContext(), parent, true);
        }

        holder.setShopLogo(mShopLogo);
        holder.setUserLogo(mUserLogo);
