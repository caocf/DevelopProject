...
import com.xhl.world.ui.main.home_new.bar.HomeTimeBuyBar;
 ...
 */
public class TimeBuyDataHolder extends RecyclerDataHolder {

    public TimeBuyDataHolder(Object data) {
        super(data);
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(Context context, int position) {
        return new RecyclerViewHolder(new HomeTimeBuyBar(context));
    }
