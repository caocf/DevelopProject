 ...
 */
public class Lopper2DataHolder extends RecyclerDataHolder {

    public Lopper2DataHolder(Object data) {
        super(data);
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(Context context, int position) {
        ...
        imageView.setLayoutParams(new RecyclerView.LayoutParams(-1, 220));
