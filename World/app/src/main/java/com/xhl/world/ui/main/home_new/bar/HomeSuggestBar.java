 ...
 */
public class HomeSuggestBar extends BaseBar implements View.OnClickListener {
    ...
    public HomeSuggestBar(Context context) {

        super(context);
    }

    public HomeSuggestBar(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
