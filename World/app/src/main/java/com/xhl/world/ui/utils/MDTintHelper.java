...
public class MDTintHelper {
    ...
    public static void setTint(@NonNull RadioButton radioButton, @ColorInt int color) {
        ColorStateList sl = new ColorStateList(new int[][]{
                ...
                MDDialogHelper.resolveColor(radioButton.getContext(), R.attr.colorControlNormal),
                color
        });
    ...
    private static ColorStateList createEditTextColorStateList(@NonNull Context context, @ColorInt int color) {
        ...
        colors[i] = MDDialogHelper.resolveColor(context, R.attr.colorControlNormal);
        i++;
    ...
    public static void setTint(@NonNull CheckBox box, @ColorInt int color) {
        ColorStateList sl = new ColorStateList(new int[][]{
                ...
                MDDialogHelper.resolveColor(box.getContext(), R.attr.colorControlNormal),
                color
        });
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
    ...
    public static void setTint(@NonNull ImageView imageView, @ColorInt int color, int drawableId) {
        ColorStateList sl = new ColorStateList(new int[][]{
                new int[]{-android.R.attr.state_enabled},
                new int[]{android.R.attr.state_enabled},
        }, new int[]{
                ContextCompat.getColor(imageView.getContext(), R.color.main_check_normal_color),
                color,
        });

        Drawable bg = ContextCompat.getDrawable(imageView.getContext(), drawableId);
