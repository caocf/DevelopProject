...
public class RippleView extends AutoRelativeLayout {
    ...
    private boolean mNeeShowRipple = true;
    ...
    private void init(final Context context, final AttributeSet attrs) {
        ...
        rippleColor = typedArray.getColor(R.styleable.RippleView_rv_color, 0x000000);
        rippleType = typedArray.getInt(R.styleable.RippleView_rv_type, 0);
        hasToZoom = typedArray.getBoolean(R.styleable.RippleView_rv_zoom, false);
        mNeeShowRipple = typedArray.getBoolean(R.styleable.RippleView_rv_need_show, true);
    ...
    public void draw(Canvas canvas) {
        super.draw(canvas);
        if (animationRunning && mNeeShowRipple) {
...
//                canvas.restore();
    ...
    public void setNeedShowRipple(boolean need) {
        mNeeShowRipple = need;
    }
