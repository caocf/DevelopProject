package com.xhl.xhl_library.ui.ptr_refresh;
...
import com.xhl.xhl_library.ui.ptr_refresh.indicator.PtrIndicator;
import com.xhl.xhl_library.ui.ptr_refresh.util.PtrCLog;
...
public class PtrFrameLayout extends ViewGroup {
    ...
    public boolean dispatchTouchEvent(MotionEvent e) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_DOWN:
                ...
                // The dialog_cancel event will be sent once the position is moved.
    ...
    private void updatePos(int change) {
        ...
        // once moved, dialog_cancel event will be sent to child
    ...
    /**
     * Not necessary any longer. Once moved, dialog_cancel event will be sent to child.
     *
     * @param yes
     */
    @Deprecated
    ...
    private void sendCancelEvent() {
        ...
        // The ScrollChecker will update position and lead to send dialog_cancel event when mLastMoveEvent is null.
        // fix #104, #80, #92
