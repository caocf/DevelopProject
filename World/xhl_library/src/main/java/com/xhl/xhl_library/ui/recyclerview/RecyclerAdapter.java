...
public class RecyclerAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    protected List<RecyclerDataHolder> mHolders = new ArrayList<RecyclerDataHolder>();
    ...
    public RecyclerAdapter(Context context, List<RecyclerDataHolder> holders) {
        ...
        mContext = context;
        if (holders != null) {
            mHolders = new ArrayList<RecyclerDataHolder>(holders.size() + 10);
    ...
    public void setDataHolders(List<RecyclerDataHolder> holders) {
        if (holders == null)
            mHolders = new ArrayList<RecyclerDataHolder>();
        else {
            mHolders = new ArrayList<RecyclerDataHolder>(holders.size() + 10);
            mHolders.addAll(holders);
        }
    ...
    @Override
    public final ViewHolder onCreateViewHolder(ViewGroup arg0, int viewType) {
        return queryDataHolder(mCurPosition).onCreateViewHolder(mContext, mCurPosition);
    }
