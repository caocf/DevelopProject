...
package com.xhl.xhl_library.ui.view.widget.wheel;
...
import com.xhl.xhl_library.ui.view.widget.wheel.adapters.WheelViewAdapter;
...
public class WheelView extends View
{
    ...
    private int backgroundResourceId = R.drawable.wheel_bg;
    private int wheelForegroundId = R.drawable.wheel_val;
    ...
    private void initResourcesIfNecessary()
    {
        ...
        {
            centerDrawable = getContext().getResources().getDrawable(wheelForegroundId);
        }
    ...
    public void setCenterDrawableResource(int paramInt)
    {
        centerDrawable = getResources().getDrawable(paramInt);
    }

    public void setTopShadowColors(int[] paramArrayOfInt)
    {
        topShadow = new GradientDrawable(
                Orientation.TOP_BOTTOM, paramArrayOfInt);
    }

    public void setBottomShadowColors(int[] paramArrayOfInt)
    {
        bottomShadow = new GradientDrawable(
                Orientation.BOTTOM_TOP, paramArrayOfInt);
    }

    public void setBackgroundResource(int paramInt)
    {
        super.setBackgroundResource(paramInt);
        backgroundResourceId = paramInt;
    }
}
