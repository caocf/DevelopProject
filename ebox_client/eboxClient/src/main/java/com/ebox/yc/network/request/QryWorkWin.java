...
public class QryWorkWin extends BaseRequest<RspWorkWin> {

	public QryWorkWin(ReqWorkWin req,
			ResponseEventHandler<RspWorkWin> listener) {
		
		super(Method.POST, YcNetworkConfig.YCServiceAddress + YcNetworkConfig.qryWorkWin, getRequestParam(req), RspWorkWin.class, listener);
	}
	
	
	private static String getRequestParam(ReqWorkWin req)
    {
