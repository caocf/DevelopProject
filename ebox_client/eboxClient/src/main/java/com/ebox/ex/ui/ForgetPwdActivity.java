 ...
 * 修改密码
 */
public class ForgetPwdActivity extends CommonActivity implements OnClickListener, EboxKeyboard.OnEboxKeyListener, ResponseEventHandler<BaseRsp> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ex_activity_forget_pwd);
    ...
    private void initView() {
        ...
        ll_voice = (LinearLayout) findViewById(R.id.ex_ll_afp_voice);
        // 密码最多32位
    ...
    View.OnTouchListener touchListener=new OnTouchListener() {
        ...
        public boolean onTouch(View view, MotionEvent motionEvent) {
            if (view instanceof EditText){
                ...
                mKeyboard.setMkeyListener(ForgetPwdActivity.this);
    ...
    private void initTitle() {
        ...
        data.tvContent = getResources().getString(R.string.ex_forget_pwd);
    ...
    private void showPrompt(int resId) {
        tip = new Tip(ForgetPwdActivity.this,
...
//            tv_error_verify.setVisibility(View.VISIBLE);
            return false;
        }
    ...
    public void onResponseSuccess(BaseRsp result) {
        dialogUtil.closeProgressDialog();
        if (result.isSuccess()) {
            new Tip(ForgetPwdActivity.this,
            ...
            timeCount.cancel();
            timeCount.onFinish();
            new Tip(this, result.getMsg(), null).show(0);
        }
    }
