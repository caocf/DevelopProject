...
public class FragmentAdvMain extends Fragment implements OnClickListener{
	...
	public void onResume() {
		super.onResume();
		dlList = AdvOp.getAdvertiseByType(AdvType.screenProtect);
		readAdv();
	}
	...
	private void readAdv() {
		...
		if (dlList != null && dlList.size() > 0) {
            ...
            {
                mAdv.add("drawable://"+R.drawable.ex_hx_screen);
            }else
            {
                mAdv.add("drawable://"+R.drawable.ex_screen_ui);
            }
	...
	private void playVideo(){
		 ...
		 */
		mVideoView.setVideoLayout(VideoView.VIDEO_LAYOUT_SCALE, (float) 1.78);
