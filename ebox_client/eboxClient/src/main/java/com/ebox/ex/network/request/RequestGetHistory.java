 ...
 * 投递记录
 */
public class RequestGetHistory extends BaseRequest<RspOperatorQueryItem> {

	public RequestGetHistory(HashMap<String, Object> parms,
	...
	private static String getURL(HashMap<String, Object> parms) {
		...
		String u= NetworkConfig.BoxServiceAddress + "/v2/delivery/history?";
