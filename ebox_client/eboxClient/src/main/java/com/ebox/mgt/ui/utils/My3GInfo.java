...
public class My3GInfo {
    ...
    public My3GInfo(Context context, TextView tv) {
        mContext = context;
        this.tv = tv;
        init();
    }
   ...
   /* 可 参考一下相关的方法，得到自己想要的参数来处理自己的ui
     ...
     */
        ...
        private void getLevel() {
            ...
            switch (position) {
                case 0:
                    tv.setText(R.string.mgt_signal_d0);
                    break;

                case 1:
                    tv.setText(R.string.mgt_signal_d1);
                    break;

                case 2:
                    tv.setText(R.string.mgt_signal_d2);
                    break;

                case 3:
                    tv.setText(R.string.mgt_signal_d3);
                    break;

                case 4:
                    tv.setText(R.string.mgt_signal_d4);
                    break;

                case 5:
                    tv.setText(R.string.mgt_signal_d5);
                    break;
            }
