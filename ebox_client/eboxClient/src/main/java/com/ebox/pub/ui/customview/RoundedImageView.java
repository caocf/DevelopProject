...
public class RoundedImageView extends ImageView
{
    ...
    public RoundedImageView(Context context, AttributeSet attrs, int defStyle)
    {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,
                R.styleable.Pub_RoundedImageView, defStyle, 0);

        int index = a
                .getInt(R.styleable.Pub_RoundedImageView_android_scaleType, -1);
        if (index >= 0)
        {
        ...
        cornerRadius = a.getDimensionPixelSize(
                R.styleable.Pub_RoundedImageView_corner_radius, -1);
        borderWidth = a.getDimensionPixelSize(
                R.styleable.Pub_RoundedImageView_border_width, -1);
        ...
        borderColor = a
                .getColorStateList(R.styleable.Pub_RoundedImageView_border_color);
        if (borderColor == null)
        {
        ...
        mutateBackground = a.getBoolean(
                R.styleable.Pub_RoundedImageView_mutate_background, false);
        isOval = a.getBoolean(R.styleable.Pub_RoundedImageView_oval, false);
