...
//	public static int mDesignWidth = 1920;
//	public static int mDesignHeight = 1080;
	public static int mDesignWidth = 1280;
	public static int mDesignHeight = 1024;
	...
	public static int scaleValue(Context context, float value) {
		DisplayMetrics mDisplayMetrics = getDisplayMetrics(context);
		//55寸固定高度
		mDisplayMetrics.heightPixels=640;
		// 为了兼容尺寸小密度大的情况
	...
	public static void scaleContentView(View view) {
	...
	public static void scaleContentView(ViewGroup contentView) {
		...
		MGViewUtil.scaleView(contentView);
