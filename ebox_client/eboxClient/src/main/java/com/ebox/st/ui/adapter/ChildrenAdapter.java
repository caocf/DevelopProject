...
public class ChildrenAdapter extends BaseListAdapter<ChildrenModel> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		final ChildrenModel info = list.get(position);
		...
		else
		{
			...
			holder.tv_name.setText("孩子"+index);
	...
	public interface onCancelClickListener{
		void OnCancelClickListener(ChildrenModel info);
	}
