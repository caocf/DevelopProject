...
public class GetfileLayout  extends OperMainLayout implements
        GetfileItemBar.TimeoutItemBarListener, Tip.onDismissListener, BoxOp.resultListener {
	...
	public GetfileLayout(Context context, AttributeSet attribute) {
		super(context, attribute);
		initViews(context);
	}

	public GetfileLayout(Context context) {
		super(context);
		initViews(context);
	}
	...
	private void showData(QueryUserFilesRsp rsp)
	{
        if(rsp!=null && rsp.getSuccess())
        {
            ...
            {
                adapter.setData(rsp.getOrder(), GetfileLayout.this);
