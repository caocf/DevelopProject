...
public class GetPayVoiceCodeRequest extends BaseRequest<BaseModel>
{
    public GetPayVoiceCodeRequest(String payId, int retry,
    ...
    {
        return String.format("%s/v1/pay/%s/balance/voice/code?%s", NetworkConfig.payAddress, payId, getRequestParam(retry));
    }
