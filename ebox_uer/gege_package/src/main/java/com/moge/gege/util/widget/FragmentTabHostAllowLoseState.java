 ...
 */
public class FragmentTabHostAllowLoseState extends TabHost implements
        TabHost.OnTabChangeListener
{
     ...
     * @param context
     */
    public FragmentTabHostAllowLoseState(Context context)
    {
     ...
     * @param attrs
     */
    public FragmentTabHostAllowLoseState(Context context, AttributeSet attrs)
    {
        super(context, attrs);
