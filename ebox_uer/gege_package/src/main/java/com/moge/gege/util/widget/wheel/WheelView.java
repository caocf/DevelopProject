...
package com.moge.gege.util.widget.wheel;
...
import com.moge.gege.util.widget.wheel.adapters.WheelViewAdapter;
...
public class WheelView extends View
{
    ...
    public void setTopShadowColors(int[] paramArrayOfInt)
    {
        topShadow = new GradientDrawable(
                GradientDrawable.Orientation.TOP_BOTTOM, paramArrayOfInt);
    }

    public void setBottomShadowColors(int[] paramArrayOfInt)
    {
        bottomShadow = new GradientDrawable(
                GradientDrawable.Orientation.BOTTOM_TOP, paramArrayOfInt);
    }
