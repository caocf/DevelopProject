package com.xhl.bqlh.utils.barcode.ui;
...
import com.xhl.bqlh.utils.barcode.CameraManager;
import com.xhl.bqlh.utils.barcode.CaptureActivityHandler;
import com.xhl.bqlh.utils.barcode.InactivityTimer;
import com.xhl.bqlh.utils.barcode.ViewfinderView;
...
public class CaptureActivity extends AppCompatActivity implements Callback,
    ...
    public void handleDecode(Result result, Bitmap barcode) {
        ...
        if (resultString.equals("")) {
            ToastUtil.showToastShort("没有识别出来");
        } else {
            //返回扫码数据
            AdEvent event = new AdEvent();
            event.adType = AdEvent.type_scan;
            event.data = resultString;
            EventHelper.postDefaultEvent(event);
//            Intent data = new Intent();
//            data.putExtra(BARCODE, resultString);
//            setResult(RESULT_OK, data);
            LogUtil.i(BARCODE + " " + resultString);
//            EventBusHelper.postScanEvent(resultString);
            this.finish();
        }
    }
