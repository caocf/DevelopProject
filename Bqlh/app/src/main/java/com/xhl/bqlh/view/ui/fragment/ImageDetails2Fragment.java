 ...
 */
public class ImageDetails2Fragment extends BaseAppFragment {
    ...
    public static ImageDetails2Fragment instance(String imageUrl) {
        ImageDetails2Fragment fragment = new ImageDetails2Fragment();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mScaleView.setBackgroundColor(Color.BLACK);
