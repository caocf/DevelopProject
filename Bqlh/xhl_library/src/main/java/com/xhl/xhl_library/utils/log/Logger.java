package com.xhl.xhl_library.utils.log;
...
public class Logger
{
  private String tag = "xhl.window";

  private static  boolean debug = BaseConfig.Logger;
  ...
  public static void i(String msg) { instance.info(msg); }
  ...
  public static void v(String msg) { instance.verbose(msg); }
  ...
  public static void d(String msg) { instance.debug(msg); }
  ...
  public static void e(Exception e) { instance.error(e); }
